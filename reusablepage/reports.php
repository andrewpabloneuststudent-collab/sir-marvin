...
<body class="p-4">
    ...
    <script>
        $(function () {
            ...
            $('#transactionModal, #monthlySalesModal, #topProductsModal, #top5ProductsModal, #cashierModal, #expiredProductsModal, #dailySalesModal, #vatDiscountModal').on('shown.bs.modal', function () {
